...
VL53L0X::VL53L0X(I2C_HandleTypeDef &hi2c) : hi2c(hi2c), m_addr(ADDRESS_DEFAULT), io_timeout(0) // no timeout
  , did_timeout(false)
{
}
...
void VL53L0X::writeReg(uint8_t reg, uint8_t value)
{
  ...
  HAL_I2C_Master_Transmit(&hi2c, m_addr, data_write, 2, 10);
}
...
void VL53L0X::writeReg16Bit(uint8_t reg, uint16_t value)
{
  ...
  HAL_I2C_Master_Transmit(&hi2c, m_addr, data_write, 3, 10);
}
...
void VL53L0X::writeReg32Bit(uint8_t reg, uint32_t value)
{
  ...
  HAL_I2C_Master_Transmit(&hi2c, m_addr, data_write, 5, 10);
}
...
uint8_t VL53L0X::readReg(uint8_t reg)
{
  ...
  data_write[0]=reg;
  HAL_I2C_Master_Transmit(&hi2c, m_addr, data_write, 1, 10);
  HAL_I2C_Master_Receive(&hi2c, m_addr, data_read, 1, 10);
  value=data_read[0];
  return value;
}
...
uint16_t VL53L0X::readReg16Bit(uint8_t reg)
{
  ...
  data_write[0]=reg;
  HAL_I2C_Master_Transmit(&hi2c, m_addr, data_write, 1, 10);
  HAL_I2C_Master_Receive(&hi2c, m_addr, data_read, 2, 10);
...
uint32_t VL53L0X::readReg32Bit(uint8_t reg)
{
  ...
  data_write[0]=reg;
  HAL_I2C_Master_Transmit(&hi2c, m_addr, data_write, 1, 10);
  HAL_I2C_Master_Receive(&hi2c, m_addr, data_read, 4, 10);
...
void VL53L0X::writeMulti(uint8_t reg, char src[], uint8_t count)
{
  ...
  data_write[0]=reg;
  HAL_I2C_Master_Transmit(&hi2c, m_addr, data_write, 1, 10);
  //HAL_I2C_Master_Transmit(&hi2c, m_addr, src, count, 0);
}
...
void VL53L0X::readMulti(uint8_t reg, char dst[], uint8_t count)
{
  ...
  data_write[0]=reg;
  HAL_I2C_Master_Transmit(&hi2c, m_addr, data_write, 1, 10);
  //HAL_I2C_Master_Receive(&hi2c, m_addr, dst, count, 0);
}
